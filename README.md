...
- A disk-quota-backed apk version pin (base images are digest-pinned and npm/pip are exact-pinned, bumped via Renovate; apk stays unpinned because Alpine repos serve only the current version).
